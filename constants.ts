...
export const FAQS: FAQItem[] = [
  {
    ...
    answer: 'No. KnitVision is fully browser-based and optimized for laptop, desktop, and tablet usage.'
  },
  {
...
export const TESTIMONIALS: Testimonial[] = [
  {
    id: 't1',
    quote: "KnitVision cut our sourcing time from 6 weeks to 3 days. The techpack auto-generation alone saved us hundreds of hours per season.",
  ...
  {
    id: 't3',
    quote: "We found sustainable suppliers we never knew existed. KnitVision's filters for certifications and transparency data are unmatched.",
