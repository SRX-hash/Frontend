    ...
    <div className="bg-white border-b border-neutral-200 sticky top-0 z-30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center cursor-pointer" onClick={() => navigate('/')}>
            ...
            <span className="text-lg font-extrabold text-neutral-900 tracking-tight">KnitVision <span className="font-medium text-neutral-400 text-sm ml-1">| Manufacturer Console</span></span>
        </div>
        ...
        <div className="flex items-center space-x-4">
            <div className="hidden sm:flex items-center space-x-2 px-3 py-1.5 bg-neutral-50 rounded-full border border-neutral-100">
                ...
                <span className="text-sm font-medium text-neutral-700">Masco Knits Ltd.</span>
            </div>
            <button 
                onClick={() => navigate('/')}
